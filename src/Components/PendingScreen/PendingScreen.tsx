...
function PendingScreen() {
  ...
  const lastSyncDate = dataModifyWithTime(
    getPendingList?.getOrderData?.lastSync
  );
  ...
  useEffect(() => {
    if (!updateStatusOnLoad && updateStatus) {
      ...
      let pickedData =
        updateStatusData?.updateOrderStatus_withMapping?.alreadyPicked;
      if (pickedData.length > 0) {
        message.warning(`Order already picked ${pickedData.toString()}`);
      } else {
  ...
  useEffect(() => {
    if (lastSync === true && lastSyncLoad === false) {
      setTimeout(() => {
        setLastSync(false);
        getPendingListApi(limit, offset);
      }, 20000);
    }
  }, [lastSync, lastSyncLoad]);
  ...
  const getPendingListApi = (limitVal: number, offsetVal: number) => {
    let isFilterApplied = JSON.stringify(pendingFilter) != JSON.stringify(pendingListFilter)
    let payload = {
  ...
  useEffect(() => {
      ...
      return() => {
        dispatch(clearReducerAction({key: "getPendingList"}))
      }
  }, []);
  ...
  const action: any = [
    {
      ...
      // dataIndex: "",
      // align: 'center',ellipsis: true, render: (item: any) => {
      //     return (
      //         <div className='jc'>
      //         </div>
      //     )
  ...
  const checkValueExist = (value: any)=>{
    if(value != null && value != "" 
     && value != undefined && value != 'null'){
      return <div title={value} className="table-data"> {value} </div>
  ...
  const pendingTable = () => {
                  ...
                  title: (
                    <div className="clear-close-input-inprogress js" style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                        <Select
                          ...
                          placeholder="Select"
                          value={pendingFilter?.fpressAllocation && pendingFilter?.fpressAllocation}
                    ...
                    <div className="clear-close-input-inprogress js" style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                          <Select className="small-input-filter jc"
                             placeholder="Select"
                              ...
                              value={pendingFilter?.fplannedQuenching && pendingFilter?.fplannedQuenching}
                            >
                      ...
                      return (
                        <div className="table-with-checkbox-data js">
                          ...
                          {user?.roleId != 1 ? (
                            ...
                            <div className="table-data">{checkValueExist(item?.processStage)}</div>
                          )}
            ...
            : user?.roleId === 5
              ...
              : user?.roleId === 6
                    ...
                    children: [
                      {
                        title: (
                          <div style={{ display: "inline-flex", gap: "5px" }}>
                           <Input type="search"  
                            style={{ width: 80 }}
                            value={pendingFilter?.fplantExtrusionLength && pendingFilter?.fplantExtrusionLength}
                            onChange={(e) => setFilterData(e.target.value, "fplantExtrusionLength")}
                          />
                          <Select style={{ width: 60 }} placeholder="Select"
                ...
                : [
                    ...
                    children: [
                      {
                        ...
                        render: (item: any) => {
                          return (
                            <div className="table-data" title={item?.po_qty}>
                              {item?.po_qty != null ? item?.po_qty : "-"}
                            </div>
                          );
                        },
                  ...
                  //       render: (item: any) => {
                  //         return (
                  //           <div className="table-data">{checkValueExist(item?.actualFrontEndCoringLength)}</div>
                  //         );
                  //       },
                  //     },
                  //   ],
                  ...
                  //       render: (item: any) => {
                  //         return (
                  //           <div className="table-data">{checkValueExist(item?.actualBackEndCoringLength)}</div>
                  //         );
                  //       },
                  //     },
                  //   ],
        ...
        : user?.roleId === 3
          ? [
            ...
            },
            {
              ...
              dataIndex: "",
              width: 300,
              key: "plannedFrontEndCoringLength1",
              align: "center",
              ellipsis: true,
              render: (item: any) => {
                return (
            ...
            },
            {
              ...
              dataIndex: "",
              width: 300,
              key: "plannedBackEndCoringLength1",
              align: "center",
              ellipsis: true,
              render: (item: any) => {
                return (
            ...
            : user?.roleId === 5
              ...
              : user?.roleId === 6
                ...
                :  [
                  ...
                  //     return (
                  //           <div className="table-data">
                  //             {checkValueExist(item?.actualFrontEndCoringLength)}
                  //           </div>
                  //     );
                  //   },
                  // },
                  ...
                  //     return (
                  //           <div className="table-data">
                  //             {checkValueExist(item?.actualBackEndCoringLength)}
                  //           </div>
    ...
    const withFilterTable = () => {
      let colArr =
        user?.roleId == 1 ? [...filterColumns, ...action] : filterColumns;
      return (
          <Table
            className="pending-new-table"
            dataSource={getOrderData}
  ...
  return (
    <div className="new-cotainer" style={{ background: "#E3E2E3" }}>
      ...
      <JindalSubMenu
        ...
        setsyncprops={setLastSync}
        lastSyncProps={lastSync}
        filter={pendingFilter}
        variable={"getPendingList"}
      />
